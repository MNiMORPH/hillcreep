...
|---|---|---|
| `probe_a_no_bedrock_scales.py` | What `k_u`, `Δz_u`, `L` and `ε̇` should ship as defaults? | `L = 100 m, K = 0.02 m/yr, H* = 0.5 m, E = 0.05 mm/yr` → `D = 0.01 m²/yr`, crest 6.25 m, toe slope 0.25 (14.0°), `u_s(toe) = 5.00 mm/yr` |
